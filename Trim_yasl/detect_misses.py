...
def process_clip(ffmpeg_path, video_path, start_time, duration, segment_file):
    command = [
        ...
        "-c:v", "libx264", "-c:a", "aac", "-strict", "experimental", "-threads", "16",'-preset', 'ultrafast', segment_file
    ]
...
if __name__ == "__main__":
    ...
    data_dir = "/auto/plzen1/home/mhruz/JSALT2024/YouTubeASL/videos/videos/"
    csv_dir = "/auto/plzen1/home/valacho/SignLLM/trim/files_timestamps/all_timestams.csv"
    output_dir = "/auto/plzen1/home/mhruz/JSALT2024/YouTubeASL/clips/"
    os.makedirs(output_dir, exist_ok=True)
    
    file_names = get_file_names(data_dir)
    file_names = [item for item in file_names if "webm.part" not in item]
    ffmpeg_path = "/auto/plzen1/home/valacho/ffmpeg/"  # Ffmpeg executable
    all_config_data = []
